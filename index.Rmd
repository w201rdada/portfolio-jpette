...
library(magrittr)
readLines('https://www.zotero.org/api/users/4689565/items/top?start=0&limit=25&format=bibtex&itemKey=AXZRYX65%2CQRN5L6D5%2CM8CI7PAW&key=BIGHhSXREPzsDa8sNCom0Odq&v=1') %>% writeLines('references.bib')
```
