...
documentclass: book
bibliography: ["references.bib", "refs2.bib"]
...
library(magrittr)
readLines('https://www.zotero.org/api/users/4689565/items/top?start=0&limit=null&format=bibtex&itemKey=M8CI7PAW&key=BIGHhSXREPzsDa8sNCom0Odq&v=1') %>% writeLines('references.bib')
```
